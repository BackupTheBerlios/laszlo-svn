...
public class HtmlGenerator {
	...
	public static class BufferOutput {
		...
		protected BufferOutput() throws IOException {
			...
			printWriter = new PrintWriter(new OutputStreamWriter(byteStream,
					"UTF-8"));
		}
	...
	protected static void flushWriter(ResponseInfo response, BufferOutput buffer)
			throws IOException {
	...
	protected static void writeHeadSection(PrintWriter out, String title,
		...
		out
				.println("<link href=\"/files/laszlo.css\" title=\"Laszlo Style\" rel=\"stylesheet\" type=\"text/css\" />");
		out.print("<title>");
		out.print(title);
		out.println("</title>");
		out.println("</head>");
	...
	protected static void makeLink(PrintWriter out, String text, String link,
			String target) {
		out.print("<a href=\"");
		out.print(link);
