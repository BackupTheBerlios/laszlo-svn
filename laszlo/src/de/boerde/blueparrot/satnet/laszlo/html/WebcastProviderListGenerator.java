 ...
 * @author roland
 */
public class WebcastProviderListGenerator extends HtmlGenerator implements
		Producer {
	private String name;
	...
	public void doGet(RequestInfo request, ResponseInfo response)
		...
		String[] refresh = { "<meta http-equiv=\"Refresh\" content=\"240;url=http://"
		...
		if (casters != null) {
			...
			for (int p = 0; p < sortedProviders.size(); p++) {
				...
				out.print("<span>");
				makeLink(out, providerNames.getDisplayName(caster), linkName,
						"castersCategoryView");
				out.print("</span>");
				out.println();
				numProviders++;
		...
		out.println("<td>");
		out
				.println("<iframe src=\"http://"
						+ settings.getHttpOwnPseudoName()
						+ "/advertising\" frameborder=\"0\" scrolling=\"no\" marginwidth=\"0\" marginheight=\"0\" width=\"100%\" height=\"60\">");
