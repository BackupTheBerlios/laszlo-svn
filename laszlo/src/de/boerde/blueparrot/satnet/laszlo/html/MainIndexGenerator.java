...
public class MainIndexGenerator extends HtmlGenerator implements Producer
{
	...
	public void doGet (RequestInfo request, ResponseInfo response) throws IOException
	{
		...
		out.println ("<frame src=\"/providers\" name=\"castersView\" scrolling=\"no\"/>");
		out.println ("<frameset cols=\"23%,*\">");
		out.println ("<frame src=\"/files/blank.html\" name=\"castersCategoryView\" />");
		out.println ("<frame src=\"/files/blank.html\" name=\"categorysPackageView\" />");
